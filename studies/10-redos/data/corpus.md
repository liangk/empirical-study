...
This file contains the cleaned 329-repo corpus used in the ReDoS study. Each repository is represented by its public GitHub URL.

## Selection Criteria

- Public GitHub repositories with active Node.js, JavaScript, or TypeScript code.
- Server-side, API, CLI, data processing, or security-focused projects where regex is likely used.
- Moderate-to-large codebases with real application or library behavior.
- Balanced coverage across five major domains.
- Canonical upstream or primary maintained forks whenever possible.

## Statistics
- Original repos: 499
- Repos removed: 170
- Valid repos retained: 329
- Removal rate: 34.07%
